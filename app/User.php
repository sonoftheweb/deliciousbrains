...
class User extends Authenticatable
{
    ...
    public function updateActivity(AccountActivity $activity, Request $request)
    {
        if ($activity->user_id !== $this->id)
            throw new \Exception('Account activity not compatible with user');
